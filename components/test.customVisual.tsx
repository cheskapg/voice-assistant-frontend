import { AgentState, TrackReferenceOrPlaceholder, useMaybeTrackRefContext, useMultibandTrackVolume } from '@livekit/components-react';
...
// import { cloneSingleChild, mergeProps } from 'D:/NachoFknCheez/Documents/JAIROSOFT/voice-assistant-frontend/node_modules/@livekit/components-react/src/utils';
import { cloneSingleChild, mergeProps } from './../node_modules/@livekit/components-react/src/utils';
import { useBarAnimator } from './../node_modules/@livekit/components-react/src/components/participant/animators/useBarAnimator';
